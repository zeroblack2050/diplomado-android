...
public class UpdateProductActivity extends BaseActivity<UpdateProductPresenter> implements IUpdateProductView, TextWatcher {
    ...
    @Override
    public void showResultUpdateNewProduct(final boolean isCreated) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                progress.hide();
                if(isCreated){
                    Toast.makeText(UpdateProductActivity.this, getResources().getString(R.string.okResponseCreateProduct), Toast.LENGTH_LONG).show();
                    finish();
                }else{
                    Toast.makeText(UpdateProductActivity.this, getResources().getString(R.string.errResponseCreateProduct), Toast.LENGTH_LONG).show();
                }
    ...
    public void showAlertInternet(final int title, final int message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(UpdateProductActivity.this, R.string.validate_internet, Toast.LENGTH_SHORT).show();
            }
        });
    }

    @Override
    public void showProductUpdate(ArrayList<Product> productArrayList) {
