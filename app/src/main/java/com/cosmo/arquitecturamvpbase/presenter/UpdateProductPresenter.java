...
import com.cosmo.arquitecturamvpbase.views.activities.IUpdateProductView;
...
public class UpdateProductPresenter extends BasePresenter<IUpdateProductView> {
    ...
    private void createNewProductService(Product product){
        try{
            ...
            getView().showResultUpdateNewProduct(true);
        }catch (RetrofitError retrofitError){
            getView().showResultUpdateNewProduct(false);
        }
    }
